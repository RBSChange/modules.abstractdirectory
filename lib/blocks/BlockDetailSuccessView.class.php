<?php
class abstractdirectory_BlockDetailSuccessView extends block_BlockView
{
	private $moduleName;
	...
	{
		$this->setTemplateName(f_util_StringUtils::ucfirst($this->moduleName) . '-Block-Detail' . f_util_StringUtils::ucfirst($this->componentName) . '-Success');
